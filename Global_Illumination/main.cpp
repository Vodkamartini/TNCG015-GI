...
int main() {
	...
	Triangle t0(v0, v1, v2, ColorDbl(0, 255, 0));
	...
	Tetrahedron* tetrahedron = new Tetrahedron(tetrahedronTriangles, 0, Vertex(8.0f, 3.0f, -4.0f, 1.0f));

	// Sphere
	Sphere* sphere = new Sphere(Vertex(5.0f, -3.0f, 2.0f, 1.0f), 1.0f, ColorDbl(255, 211, 0), 0, Vertex(5.0f, -3.0f, 2.0f, 1.0f));
	...
	LightSource light(lightTriangles, 2, Vertex(5.0f, 0.0f, 4.99f, 1.0f), 2.0);
